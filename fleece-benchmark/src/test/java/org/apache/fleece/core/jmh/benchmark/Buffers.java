...
public class Buffers {
    ...
    public static final byte[] GENHUGE_BYTES = readBytes( "/bench/huge_1mb.json" );
    public static final byte[] GENMEDIUM_BYTES = readBytes( "/bench/medium_11kb.json" );
    public static final byte[] GENMEDIUM_GIANT = readBytes( "/bench/gen_giant.json" );
    public static final byte[] GENMEDIUM_TINY = readBytes( "/bench/tiny_50b.json" );
    ...
    public static final String STR_GENHUGE_BYTES = readStr( "/bench/huge_1mb.json" );
    public static final String STR_GENMEDIUM_BYTES = readStr( "/bench/medium_11kb.json" );
    public static final String STR_GENMEDIUM_GIANT = readStr( "/bench/gen_giant.json" );
    ...
    public static final String STR_GENMEDIUM_TINY = readStr( "/bench/tiny_50b.json" );
    ...
    public static final char[] CHR_GENHUGE_BYTES = readChars( "/bench/huge_1mb.json" );
    public static final char[] CHR_GENMEDIUM_BYTES = readChars( "/bench/medium_11kb.json" );
    public static final char[] CHR_GENMEDIUM_GIANT = readChars( "/bench/gen_giant.json" );
 ...
 //   public static final char[] CHR_UNICODESTXT_BIG_BYTES = readChars( "/bench/unicodes_big.txt" );
    public static final char[] CHR_GENMEDIUM_TINY = readChars( "/bench/tiny_50b.json" );
