...
public class JsonFastUTF8ByteBufferStreamParserBenchmark extends BenchmarkRawStreamParser {

    @Override
    protected Object parse(final InputStream stream) throws Exception {
        final JsonParser parser = new JsonFastUTF8ByteBufferStreamParser(stream, 8192, BufferStrategy.BY_INSTANCE.newProvider(8192));
